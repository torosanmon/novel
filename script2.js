document.addEventListener("DOMContentLoaded", function() {
    ...
    "そんなわけで、待ち受ける途方もない時間をせめて｢まとも｣にできるよう、\n学友たちと足並みそろえて就職活動というものに勤しみ始め早数か月。\n結果は、芳しくない。",
    "昔からの憧れを追い続ける奴、エリート街道を突き進む奴。\nそんな奴らを見る度、自分の足元が覚束なくなるのを感じる。\nやりたいことも、将来のために積み重ねた実績も\n歩んできた人生という澱をどれだけこそいでも何一つ見当たらない。\n中途半端、昔から何もかも｢ほどほど｣止まりだった。\nほどほどで積み重ねた人生経験は、ほどほどな人間を形作る。",
    "｢ままならないもんだね･･･｣\nメールアプリのタブを消去し、意味もなくSNSを開こうとしたとき、\n｢･･･ん？｣\nホーム画面の隅に、見慣れないアプリがあるのに気づく。",
    "無地で鈍色の四角形、\nこれといった特徴のないアイコン。\nタイトルすらない。",
    "｢なんこれ｣\n自分で入れた記憶はない、おそらくスマホ本体のデフォルトアプリか何かが\n意図しない操作の拍子にホーム画面に移動してしまっただけだろう。\nだがもし何らかの不具合やバグなら、\nちょっとした話のタネくらいにはなるかもしれない。\n\nそう思い、何気なくそのアイコンに触れる。",
    "あなたの願いは？",
    "眉を顰める。ポップアップされたのはこれまた無機質なテキスト入力ボックス。\nそして、この一文。\n意味が分からない。一瞬情報を抜き取る有害アプリかとも思ったが、にしては\n質問が抽象的すぎる。\n\n｢･････。｣",
    ...
    "大手企業に勤める、時給をあげる。\n今までの願いはどれも｢これからを頑張る｣ためのモノばかりだった。\n満たされない人生の中で求めたのは全て、満たすための導線だった。\nだが今回のそれは違う。\n何も頑張ることのない、それは、あらゆる努力からの脱却。\n",
    "働く努力、学ぶ努力、\n見る努力、食べる努力、息をする努力。",
    ...
    let currentText = "";
    let charIndex = 0;
    const formLink = 'https://docs.google.com/forms/d/e/1FAIpQLSf_pX8e-pu18As-NW4RxIwcXxdRkbiHZDElUkDj6za9mzTKNg/viewform?usp=sf_link';
